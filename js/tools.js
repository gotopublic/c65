            ...
            if (result.result === false) {
                ...
                if (count === length - 1) {
                    ...
                    for (var x = 0; x < objLength; x++) {
                        ...
                        datatableList[row] = ['<div class="land">' + record.land + '</div>',
                    ...
                    let lokaTable = $('#lokaDatatable').DataTable({
                        ...
                        "columnDefs": [
                            ...
                            {searchPanes: {header: cLand, show: true}, targets: [0]},
                            {searchPanes: {header: cKingdomId, show: true}, targets: [1]},
                            {searchPanes: {header: cName, show: true}, targets: [2]},
                            {searchPanes: {header: cWallet, show: true}, targets: [3]},
                    ...
                    document.getElementsByClassName('topBar')[0].insertAdjacentHTML('beforeend',
                            '<div id="datProf">\n\
                                    ...
                                    <div id="contProfit">\n\
                                    <label id="cPercentageLabel">C65 Profit Percentage</label>\n\
                                    ...
                                    <input type="text" id="cProfit" value="" placeholder="C65 Total LOKA Profit" readonly/>\n\
                                    </div>\n\
                                    </div>');
                }
                count++;
